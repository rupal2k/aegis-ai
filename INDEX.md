...
- **[[Bug Log]]** — 10 bugs, root causes, fixes, prevention
...
- **[[Daily notes]]** — Phase 5 dev journal (2026-04-18)
- **[[Daily Notes/Daily notes]]** — 2026-04-24 session notes: dashboard fixes + presentation retheme
...
| Dashboard | ✅ Live (HF Spaces + local Docker) |
...
| Deployed | ✅ Neon (DB) + Render (API) + HF Spaces (dashboard) |
...
└── Aegis AI\                             ← project notebook
    ...
    ├── Bug Log.md                        (10 bugs, root causes, fixes)
    ...
    ├── Daily notes.md                    (Phase 5 dev journal — 2026-04-18)
    ...
    ├── Daily Notes\
    │   └── Daily notes.md                (2026-04-24 session notes)
    └── Security Tests\
...
4. **Hit a bug?** Check **[[Bug Log]]** first — 10 pitfalls already documented
...
- **API (Render)**: `https://aegis-ai-wss8.onrender.com`
- **Dashboard (HF Spaces)**: `https://huggingface.co/spaces/Rupa2k/aegis-ai`
